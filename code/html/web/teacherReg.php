<?php
	require "../src/ValidateTeacherReg.php"; //Validate input and add user to db

	// if(isset($_SESSION['login_user'])){ //If all input was valid, start new users session
...
<head>
	...
	<title>Wordbricks teacher registration</title>
...
<body>
	...
	<div class="container layer">
		<div class="row main">
				...
				<h3 class="lead text-center"><strong>TEACHER</strong></h3>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="class-name" id="class-name"  placeholder="Enter Class Name"/>
								</div>
							</div>
							<!-- Warning that field is required if left blank-->
							<?php echo $classNameErr;?>
						</div>
